...
function buildMenu() {
  ...
  const firstDish = createDishes(
    Salmon,
    "first-dish",
    "Grilled Salmon Delight",
    "₹1699",
    "Lemon Herb Quinoa, lemon herb marinade, quinoa, cherry tomatoes, spinach."
  );
  firstCtn.appendChild(firstDish);

  const secondDish = createDishes(
    Chicken,
    "second-dish",
    "Chicken Alfredo",
    "₹99",
    "Grilled chicken breast, creamy Alfredo sauce, fettuccine pasta, garlic, Parmesan cheese, parsley."
  );
  ...
  const thirdDish = createDishes(
    Vegwrap,
    "first-dish",
    "Vegetarian Garden Wrap",
    "₹499",
    "Spinach wrap, hummus, cucumber, bell peppers, cherry tomatoes, red onion, mixed greens."
  );
  secondCtn.appendChild(thirdDish);

  const fourthDish = createDishes(
    Porkribs,
    "second-dish",
    "BBQ Pork Ribs",
    "₹699",
    "Pork ribs, homemade barbecue sauce, coleslaw, baked beans, cornbread."
  );
